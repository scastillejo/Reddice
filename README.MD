I took Rem Zolotykh's app based on create-react-app npm utility and modified it to query a MongoDb database (the original one is configured to use Knex queries). 
